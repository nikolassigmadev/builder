          ...
          <footer style={{ backgroundColor: footerBg, borderTop: `1px solid ${colors.primary}15`, padding: "64px 24px 32px" }}>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs"
                ...
                <Link href="/admin" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all hover:opacity-100 hover:scale-105 active:scale-95" style={{ backgroundColor: `${colors.primary}18`, color: colors.primary, border: `1px solid ${colors.primary}30`, opacity: 0.7 }}>
